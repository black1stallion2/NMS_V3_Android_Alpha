...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void addToFav(ItemSong itemSong) {
        ...
        String insert = "insert into song (sid,title,desc,artist,duration,url,image,image_small,cid,cname,total_rate,avg_rate) values ('" + itemSong.getId() + "', '" + name + "', " + a + ", '" +itemSong.getArtist() + "', '" + itemSong.getDuration() + "', '" + itemSong.getMp3Url() + "', '" + itemSong.getImageBig() + "', '" + itemSong.getImageSmall() + "', '" + itemSong.getCategoryId() + "', '" + cat_name + "', '" + itemSong.getTotalRate() + "', '" + itemSong.getAverageRating() + "')";
        dml(insert);
    }
    ...
    public void addToRecent(ItemSong itemSong) {
        ...
        String name = itemSong.getMp3Name().replace("'","%27");
        String cat_name = itemSong.getCategoryName().replace("'","%27");
        String insert = "insert into recent (sid,title,desc,artist,duration,url,image,image_small,cid,cname,total_rate,avg_rate) values ('" + itemSong.getId() + "', '" + name + "', " + a + ", '" + itemSong.getArtist() + "', '" + itemSong.getDuration() + "', '" + itemSong.getMp3Url() + "', '" + itemSong.getImageBig() + "', '" + itemSong.getImageSmall() + "', '" + itemSong.getCategoryId() + "', '" + cat_name + "', '" + itemSong.getTotalRate() + "', '" + itemSong.getAverageRating() + "')";
        dml(insert);
    }
    ...
    public void addToPlayList(ItemSong itemSong, String pid) {
        ...
        String name = itemSong.getMp3Name().replace("'","%27");
        String cat_name = itemSong.getCategoryName().replace("'","%27");
        String insert = "insert into "+ TABLE_PLAYLIST_SONG +"("+TAG_SID+","+TAG_TITLE+","+TAG_DESC+","+TAG_ARTIST+","+TAG_DURATION+","+TAG_URL+","+TAG_IMAGE+","+TAG_IMAGE_SMALL+","+TAG_CID+","+TAG_CNAME+","+TAG_PID+","+TAG_TOTAL_RATE+","+TAG_AVG_RATE+") values ('" + itemSong.getId() + "', '" + name + "', " + a + ", '" + itemSong.getArtist() + "', '" + itemSong.getDuration() + "', '" + itemSong.getMp3Url() + "', '" + itemSong.getImageBig() + "', '" + itemSong.getImageSmall() + "', '" + itemSong.getCategoryId() + "', '" + cat_name + "', '" + pid + "', '" + itemSong.getTotalRate() + "', '" + itemSong.getAverageRating() + "')";
        dml(insert);
    }
    ...
    public ArrayList<ItemSong> loadData() {
        ...
        if(cursor!=null && cursor.getCount() > 0) {
            ...
            for(int i=0; i<cursor.getCount();i++) {
                ...
                ItemSong objItem = new ItemSong(id,cid,cname,artist,url,imagebig,imagesmall,name,duration,desc,total_rate, avg_rate);
                arrayList.add(objItem);
